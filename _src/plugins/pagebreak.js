    ...
    return function () {
        ...
        me.ready(function () {
            utils.cssRule('pagebreak',
                '.pagebreak{display:block;clear:both !important;'
                + 'cursor:default !important;width: 100% !important;margin:0;}',
                me.document);
        });
        function isHr(node) {
        ...
        me.addOutputRule(function (node) {
            utils.each(node.getNodesByTagName('hr'), function (n) {
                if (n.getAttr('class') === 'pagebreak') {
                    var txt = uNode.createText(me.options.pageBreakTag);
