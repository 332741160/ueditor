...
define(function (require) {
    ...
    function fn() {
        ...
        function initUploadBtn() {
            ...
            var btnStyle = 'display:block;width:'
                + w + 'px;height:' + h
                + 'px;overflow:hidden;border:0;margin:0;padding:0;position:absolute;'
                + 'top:0;left:0;filter:alpha(opacity=0);-moz-opacity:0;-khtml-opacity: 0;opacity: 0;cursor:pointer;';
    ...
    plugin.register('simpleupload', fn);
});
