...
define(function (require) {
    ...
    return function () {
            ...
            if (LteIE6 || (quirks && browser.ie)) {
                ...
                if (browser.ie7Compat && flag) {
                    ...
                    toolbarBox.style.left = domUtils.getXY(toolbarBox).x
                        - document.documentElement.getBoundingClientRect().left + 2 + 'px';
                }
                ...
                if (toolbarBox.style.position !== 'fixed') {
                    ...
                    ((origalFloat === 'absolute' || origalFloat === 'relative')
                        && parseFloat(origalLeft)) && (toolbarBox.style.left = toobarBoxPos.x + 'px');
                }
            }
        }
        ...
        var defer_updateFloating = utils.defer(function () {    // eslint-disable-line
            updateFloating();
