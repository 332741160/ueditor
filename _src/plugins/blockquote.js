        ...
        me.commands.blockquote = {
            execCommand: function (cmdName, attrs) {
                ...
                if (obj) {
                    ...
                    var startBlock = domUtils.isBlockElm(start) ? start : domUtils.findParent(start, function (node) {
                            return domUtils.isBlockElm(node);
                        });
                    var end = range.endContainer;
                    var endBlock = domUtils.isBlockElm(end) ? end : domUtils.findParent(end, function (node) {
                            return domUtils.isBlockElm(node);
                        });
                    ...
                    if (startBlock.tagName === 'LI'
                        ...
                        || startBlock === obj || domUtils.isBody(startBlock)) {
                    ...
                    var node = tmpRange.startContainer.nodeType === 1
