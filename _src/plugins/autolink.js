...
define(function (require) {
    ...
    function fn() {
        return !browser.ie ? {
            bindEvents: {
                ...
                keydown: function (type, evt) {   // eslint-disable-line
                    var me = this;
                    ...
                    if (keyCode === 32 || keyCode === 13) {
                        ...
                        while (start.nodeType === 1 && range.startOffset > 0) {
                            ...
                            range.setStart(start, start.nodeType === 1
                                ? start.childNodes.length : start.nodeValue.length);
                            range.collapse(true);
    ...
    plugin.register('autolink', fn, afterDisabled);
});
