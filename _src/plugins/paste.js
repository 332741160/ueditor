...
define(function (require) {
    ...
    var filterWord = require('../core/filterword');
    var filterNode = require('../core/filternode');
    ...
    return function () {
        function getClipboardData(callback) {
            ...
            pastebin.style.cssText = 'position:absolute;width:1px;height:1px;'
                + 'overflow:hidden;left:-1000px;white-space:nowrap;top:'
        ...
        function filter(div) {
            ...
            if (div.firstChild) {
                ...
                root = htmlparser(html.html, true);
                // 如果开启了纯文本模式
                if (me.queryCommandState('pasteplain') === 1) {
                    me.execCommand('insertHtml', filterNode(root, me.options.filterTxtRules).toHtml(), true);
                }
                else {
                    // 文本模式
                    filterNode(root, me.options.filterTxtRules);
