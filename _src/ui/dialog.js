...
define(function (require) {
    ...
    Dialog.prototype = {
        ...
        initResizeEvent: function () {
            ...
            domUtils.on(window, 'resize', function () {
                ...
                me.__resizeTimer = window.setTimeout(function () {
                    ...
                    var contentRect = uiUtils.getClientRect(contentNode);
        ...
        _onTitlebarMouseDown: function (evt, el) {    // eslint-disable-line
            if (this.draggable) {
                var rect;
                var me = this;
        ...
        _show: function () {    // eslint-disable-line
            if (this._hidden) {
                ...
                this._hidden = false;
                this.fireEvent('show');
                uiUtils.getFixedLayer().style.zIndex = this.getDom().style.zIndex - 4;
            }
        ...
        _hide: function () {    // eslint-disable-line
            if (!this._hidden) {
        ...
        _onCloseButtonClick: function (evt, el) {   // eslint-disable-line
            this.close(false);
        },
        close: function (ok) {
