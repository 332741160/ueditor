...
define(function (require) {
     ...
     * @class
     */
    function AutoTypeSetButton(options) {
                    ...
                    if (attrValue) {
                        if (/input/ig.test(attrValue.tagName)) {
                            ...
                            for (var j = iptChilds.length - 1, iptchild; iptchild = iptChilds[j--];) {
                                if (iptchild.checked) {   // eslint-disable-line
