...
define(function (require) {
    ...
    var domUtils = {
         ...
         * @method findParents
         * @param { Node } node 需要查找的节点对象
         * @param {*} includeSelf The includeSelf.
         * @param {*} filterFn The filterFn.
         * @param {*} closerFirst The closerFirst.
         ...
         *
         * @method split
         * @param { Node } node 需要拆分的文本节点对象
         * @param {number} offset 需要拆分的位置， 位置计算从0开始
         ...
         * @param {string} name 需要查找的节点的tagName， 多个tagName以空格分割
        ...
        mergeSibling: function (node, ignorePre, ignoreNext) {
            function merge(rtl, start, node) {
                ...
                if ((next = node[rtl]) && !domUtils.isBookmarkNode(next)
                    && next.nodeType === 1 && domUtils.isSameElement(node, next)) {
         ...
         *
         * @method removeClasses
         * @param { Element } elm 需要删除class的元素节点
         ...
         *
         * @method addClass
         * @param { Node } elm 需要增加className的元素
         ...
         *
         * @method hasClass
         * @param { Node } element 需要检测的元素
         * @param { Array } className 需要检测的className数组
         * @return {boolean} 元素是否包含所有给定的className
         * @example
         * ```html
         * <span id="test1" class="cls1 cls2"></span>
         ...
         * @param {string} name 需要获取的style的名称
        ...
        isStartInblock: function (range) {
            ...
            while (!tmpRange.startOffset) {
                ...
                pre = tmpRange.startContainer.previousSibling;
                var tmpNode;
                if (!pre) {
         ...
         * @method filterNodeList
         * @param { Array } nodelist 需要过滤的节点数组
         * @param { Function } filter 过滤器， 对符合条件的节点， 执行结果返回true， 反之则返回false
