...
define(function (require) {
     ...
     *
     * @constructor
     * @param { Object } obj 传入要创建的uNode的初始属性
     * @example
     * ```javascript
     * var node = new uNode({
     *     type:'element',
    ...
    var notTransAttrs = {
        href: 1,
        src: 1,
        _src: 1,            // eslint-disable-line
        _href: 1,           // eslint-disable-line
        cdata_data: 1       // eslint-disable-line
    };
    ...
    uNode.createElement = function (html) {
        ...
        return new uNode({    // eslint-disable-line
            type: 'element',
            children: [],
            tagName: html
        });
    ...
    function isElement(node, arr, formatter, current) {
        ...
        if (node.attrs) {
            ...
            for (var a in attrs) {    // eslint-disable-line
                ...
                // 有可能做的不够
                attrhtml.push(a + (attrs[a] !== undefined ? '="'
    ...
    uNode.prototype = {
        ...
        innerHTML: function (htmlstr) {
            ...
            tmpRoot = new uNode({   // eslint-disable-line
                type: 'root',
        ...
        setStyle: function (name, val) {
            ...
            cssStyle = this.getAttr('style');
            if (!cssStyle) {
                cssStyle = '';
            }

            if (utils.isObject(name)) {
                for (var a in name) {     // eslint-disable-line
                    exec(a, name[a]);
                }
            }
            else {
