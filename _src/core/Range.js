...
define(function (require) {
    ...
    var fillCharReg = domUtils.fillCharReg;
    var guid = 0;
    ...
    function execContentsAction(range, action) {  // eslint-disable-line
        // 调整边界
        ...
        if (action) {
            range.setStartBefore(!endParents[i]
                ? endParents[i - 1]
                : !startParents[i] ? startParents[i - 1] : endParents[i]).collapse(true);
        }
     ...
     *
     * @param {*} doc The doc.
     * @param {*} excludeNode The excludeNode.
     */
    ...
    Range.prototype = {
         ...
         * @param {number} offset 选区的开始位置偏移量
         ...
         *                      反之，则向开始容器方向闭合
         * @param {*} noFillData The noFillData.
         * @return { UE.dom.Range } 当前range对象
         ...
         * @param {*} stopFn The stopFn.
         * @return { UE.dom.Range } 当前range对象
         */
        enlarge: function (toBlock, stopFn) {   // eslint-disable-line
         ...
         *
         * @method removeInlineStyle
         * @param { Array } tagNames 需要移除的标签名的数组
         * @return { UE.dom.Range } 当前的range对象
         ...
         * @private
         * @param {*} ignoreEnd The ignoreEnd.
         * @param {*} ignoreTxt The ignoreTxt.
         ...
         *
         * @method equals
         * @param { UE.dom.Range } rng 需要判断的Range对象
